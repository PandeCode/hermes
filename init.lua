vim.loader.enable()
package.preload["fnl.utils"] = package.preload["fnl.utils"]
	or function(...)
...
require("fnl.utils")
package.preload["fnl.options"] = package.preload["fnl.options"]
	or function(...)
		...
		for k, v in pairs({
			...
			colorcolumn = "80",
			list = true,
			listchars = "tab:\226\134\146 ,lead:\194\183,trail:\194\183,nbsp:\226\144\163",
			pumblend = 20,
			winblend = 20,
			showmatch = true,
			scrolloff = 8,
...
require("fnl.options")
package.preload["fnl.keymaps"] = package.preload["fnl.keymaps"]
	or function(...)
		vim.g.mapleader = " "
...
require("fnl.keymaps")
package.preload["fnl.autocmds"] = package.preload["fnl.autocmds"]
	or function(...)
		local function _19_()
...
package.preload["fnl.plugins"] = package.preload["fnl.plugins"]
	or function(...)
			...
			(
				{
					highlighters = {
						...
						hex_num = { pattern = "0x%x%x%x%x%x%x%f[%X]", group = _31_, extmark_opts = { priority = 200 } },
					},
				} or {}
			)
		)
		...
		mini_s.setup({
			...
			custom_surroundings = {
				...
				b = { input = ts_input({ outer = "@block.out", inner = "@block.inner" }) },
				[")"] = { output = { left = "( ", right = " )" } },
				["*"] = { input = _32_, output = _33_ },
			},
		})
		vim.keymap.del("x", "ys")
					...
					completion = {
						menu = {
							draw = {
								...
								components = { kind_icon = { text = _35_, highlight = _36_ }, kind = {
									highlight = _37_,
								} },
							},
						},
		...
		vim.lsp.config(
			"nixd",
			{
				settings = {
					nixd = {
						nixpkgs = { expr = (vim.g.nix_nixd_nixpkgs or "import <nixpkgs> {}") },
						options = {
							nixos = { expr = vim.g.nix_nixd_nixos_options },
...
require("fnl.plugins")
package.preload["fnl.theme"] = package.preload["fnl.theme"]
	or function(...)
		local base16
		do
...
require("fnl.theme")
package.preload["fnl.statusline"] = package.preload["fnl.statusline"]
	or function(...)
		Statusline = {}
		...
		local function git()
			...
			if d then
				...
				return (
					("%#" .. "GitSignsAdd" .. "#" .. tostring((" \238\156\165 " .. d.head)) .. "%*")
					.. " "
					.. _70_
					.. _72_
					.. _74_
		...
		local function mode()
			local modes = {
				n = { "(\227\131\187_\227\131\187)", "base0D", "base00" },
				i = { "(\227\129\163\226\128\162\204\128\207\137\226\128\162\204\129)\227\129\163", "base0B", "base00" },
				v = { "(\225\151\146\225\151\168\225\151\149)", "base0E", "base00" },
				V = { "(\225\151\146\225\151\168\225\151\149)\226\148\129", "base0E", "base00" },
				["\22"] = { "(\225\151\146\225\151\168\225\151\149)\226\150\136", "base0E", "base00" },
				c = { "(\224\184\135 \226\128\162\204\128_\226\128\162\204\129)\224\184\135", "base0A", "base00" },
				R = { "(\235\136\136_\235\136\136)", "base08", "base00" },
			}
			local m = vim.fn.mode()
...
package.preload["fnl.tabline"] = package.preload["fnl.tabline"]
	or function(...)
		Tabline = {}
		do
			local p = MiniBase16.config.palette
		...
		local function listed_bufs()
			...
			return vim.tbl_filter(_105_, vim.api.nvim_list_bufs())
		end
		local function buf_diag(buf)
			...
			local _106_
			if e > 0 then
				_106_ = ("%#DiagnosticSignError# " .. e .. "%*")
			else
				_106_ = ""
			end
			local _108_
			if w > 0 then
				_108_ = ("%#DiagnosticSignWarn# " .. w .. "%*")
			else
				_108_ = ""
			end
			return (_106_ .. _108_)
		...
		local function workspace_diag()
			...
			local _114_
			if h > 0 then
				_114_ = ("%#DiagnosticSignHint# " .. h .. "%*")
			else
				_114_ = ""
			end
			local _116_
			if i > 0 then
				_116_ = ("%#DiagnosticSignInfo# " .. i .. "%*")
			else
				_116_ = ""
			end
			return (_110_ .. _112_ .. _114_ .. _116_)
		end
...
require("fnl.tabline")
package.preload["fnl.dap"] = package.preload["fnl.dap"]
	or function(...)
...
vim.api.nvim_create_autocmd(
	"ModeChanged",
	{ group = vim.api.nvim_create_augroup("diagnostic_redraw", {}), callback = _132_ }
)
